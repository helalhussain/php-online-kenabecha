...
<div class="container pt-4">
        ...
        <div class="row pt-3 bg-info">
            <div class="col-lg-3">
                <a href="#" style="font-size:20px;font-weight:bold; color:#fff;"><i class="fas fa-map-marker-alt"></i>Chattogram</a>
            </div>
            <div class="col-lg-3">
...
<!-------------------------------------------------------->
            <div class="row pt-4 pb-4 bg-white">
                ...
                <h5 class="text-dark" style="font-size:14px;"><a href="onlinekenabecha.php">Home</a> / <a href="all-ads.php">All ads</a> / <a href="chattogram.php">Chattogram</a></h5>
                <h5 class="font-weight-bold text-info">Chattogram</h5><hr><br>
...
<!----------------------------------------all ads echo start-------------------------->
     <?php
             ...
             if(isset($_GET['page'])){
              ...
              $offset =($page -1) * $limit;
                 $qu ="SELECT * FROM ad_post WHERE able='able' and user_division='Chattogram' ORDER BY post_id DESC LIMIT {$offset}, {$limit}";
     ...
     <!--------------------------------Ads echo end--------------------------------->
                    ...
                    <?php 
                        ...
                        $sql1 = "SELECT * FROM ad_post WHERE able='able' and user_division='Chattogram'";
                        ...
                        if(mysqli_num_rows($result1) > 0){
                            ...
                            if($page > 1){
                                ...
                                <a href="chattogram.php?page='.($page - 1).'" class="page-link font-weight-bold">Prev</a>
                                </li>';
                            }
                            for($i =1; $i<=$total_page; $i++){
                                ...
                                <a class="page-link font-weight-bold" href="chattogram.php?page='.$i.'">'.$i.'</a>
                                </li>  ';
                             
                            }
                            if($total_page > $page){
                                echo '<li class="page-item ">
                            <a  href="chattogram.php?page='.($page + 1).'" class="page-link font-weight-bold" >Next</a>
                            </li>';
                            }
                            echo '</ul></nav>';
