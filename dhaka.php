...
<!--                         <a href="recomendation.php">
                ...
                <h5 class="text-dark" style="font-size:14px;"><a href="onlinekenabecha.php">Home</a> / <a href="all-ads.php">All ads</a> / <a href="dhaka.php">Dhaka</a></h5>
                <h5 class="font-weight-bold text-info">Dhaka</h5><hr><br>
...
<!----------------------------------------all ads echo start-------------------------->
     <?php
             ...
             if(isset($_GET['page'])){
              ...
              $offset =($page -1) * $limit;
                 $qu ="SELECT * FROM ad_post WHERE able='able' and user_division='Dhaka' ORDER BY post_id DESC LIMIT {$offset}, {$limit}";
     ...
     <!--------------------------------Ads echo end--------------------------------->
                    ...
                    <?php 
                        ...
                        $sql1 = "SELECT * FROM ad_post WHERE able='able' and user_division='Dhaka'";
                        ...
                        if(mysqli_num_rows($result1) > 0){
                            ...
                            if($page > 1){
                                ...
                                <a href="dhaka.php?page='.($page - 1).'" class="page-link font-weight-bold">Prev</a>
                                </li>';
                            }
                            for($i =1; $i<=$total_page; $i++){
                                ...
                                <a class="page-link font-weight-bold" href="dhaka.php?page='.$i.'">'.$i.'</a>
                                </li>  ';
                             
                            }
                            if($total_page > $page){
                                echo '<li class="page-item ">
                            <a  href="dhaka.php?page='.($page + 1).'" class="page-link font-weight-bold" >Next</a>
                            </li>';
                            }
                            echo '</ul></nav>';
