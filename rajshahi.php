...
<div class="container pt-4">
        ...
        <div class="row pt-3 bg-info">
            <div class="col-lg-3">
                <a href="#" style="font-size:20px;font-weight:bold; color:#fff;"><i class="fas fa-map-marker-alt"></i> Dhaka</a>
            </div>
            <div class="col-lg-3">
            <a href="#" style="font-size:20px;font-weight:bold;color:#fff;"><i class=""></i> All Category</a>
            </div>
            <div class="col-lg-6">
...
<!--                         <a href="recomendation.php">
                ...
                <h5 class="text-dark" style="font-size:14px;"><a href="onlinekenabecha.php">Home</a> / <a href="all-ads.php">All ads</a> / <a href="rajshahi.php">Rajshahi</a></h5>
                <h5 class="font-weight-bold text-info">Rajshahi</h5><hr><br>
...
<!----------------------------------------all ads echo start-------------------------->
     <?php
             ...
             if(isset($_GET['page'])){
              ...
              $offset =($page -1) * $limit;
                 $qu ="SELECT * FROM ad_post WHERE able='able' and user_division='Rajshahi' ORDER BY post_id DESC LIMIT {$offset}, {$limit}";
     ...
     <!--------------------------------Ads echo end--------------------------------->
                    ...
                    <?php 
                        ...
                        $sql1 = "SELECT * FROM ad_post WHERE able='able' and user_division='Rajshahi'";
                        ...
                        if(mysqli_num_rows($result1) > 0){
                            ...
                            if($page > 1){
                                ...
                                <a href="rajshahi.php?page='.($page - 1).'" class="page-link font-weight-bold">Prev</a>
                                </li>';
                            }
                            for($i =1; $i<=$total_page; $i++){
                                ...
                                <a class="page-link font-weight-bold" href="rajshahi.php?page='.$i.'">'.$i.'</a>
                                </li>  ';
                             
                            }
                            if($total_page > $page){
                                echo '<li class="page-item ">
                            <a  href="rajshahi.php?page='.($page + 1).'" class="page-link font-weight-bold" >Next</a>
                            </li>';
                            }
                            echo '</ul></nav>';
