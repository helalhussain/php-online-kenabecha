...
<div class="container pt-4">
        ...
        <div class="row pt-3 bg-info">
            ...
            <div class="col-lg-3">
            <a href="#" style="font-size:20px;font-weight:bold;color:#fff;"><i class=""></i> Hobbies & Sports</a>
            </div>
            <div class="col-lg-6">
...
<!--                         <a href="recomendation.php">
                ...
                <h5 class="text-dark" style="font-size:14px;"><a href="onlinekenabecha.php">Home</a> / <a href="all-ads.php">All ads</a> / <a href="sports.php">Hobbies & Sports</a></h5>
                <h5 class="font-weight-bold text-info">Hobbies & Sports in Bangladesh</h5><hr><br>
...
<!----------------------------------------all ads echo start-------------------------->
     <?php
             ...
             if(isset($_GET['page'])){
              ...
              $offset =($page -1) * $limit;
                 $qu ="SELECT * FROM ad_post WHERE able='able' and category='Sport' ORDER BY post_id DESC LIMIT {$offset}, {$limit}";
     ...
     <!--------------------------------Ads echo end--------------------------------->
                    ...
                    <?php 
                        ...
                        $sql1 = "SELECT * FROM ad_post WHERE able='able' and category='Sport'";
                        ...
                        if(mysqli_num_rows($result1) > 0){
                            ...
                            if($page > 1){
                                ...
                                <a href="sports.php?page='.($page - 1).'" class="page-link font-weight-bold">Prev</a>
                                </li>';
                            }
                            for($i =1; $i<=$total_page; $i++){
                                ...
                                <a class="page-link font-weight-bold" href="sports.php?page='.$i.'">'.$i.'</a>
                                </li>  ';
                             
                            }
                            if($total_page > $page){
                                echo '<li class="page-item ">
                            <a  href="sports.php?page='.($page + 1).'" class="page-link font-weight-bold" >Next</a>
                            </li>';
                            }
                            echo '</ul></nav>';
