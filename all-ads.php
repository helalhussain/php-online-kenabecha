...
<div class="container pt-4">
        ...
        <div class="row pt-3 bg-info">
            <div class="col-lg-3">
                <a href="#" style="font-size:20px;font-weight:bold; color:#fff;"><i class="fas fa-map-marker-alt"></i> Location</a>
            </div>
            <div class="col-lg-3">
            <a href="#" style="font-size:20px;font-weight:bold;color:#fff;"><i class=""></i> All ads</a>
            </div>
            <div class="col-lg-6">
                ...
                <div class="col-lg-3">
                    ...
                    <a href="all-ads.php">
                        <li class="list-group-item d-flex font-weight-bold justify-content-between align-items-center text-primary">
                            Newest on top
                            <span class="badge badge-primary badge-pill "><i class="fa fa-angle-right"></i></span>
                        </li>
                        </a>
<!--                         <a href="recomendation.php">
                        <li class="list-group-item d-flex font-weight-bold justify-content-between align-items-center">
                            Recomendation
                            <span class="badge badge  badge-pill"><i class="fa fa-angle-right font-weight-bold"></i></span>
                        </li>
                        </a> -->
                ...
                <h5 class="text-dark" style="font-size:14px;"><a href="onlinekenabecha.php">Home</a> / <a href="all-ads.php">All ads in Bangladesh</a></h5>
                <h5 class="font-weight-bold text-info">All ads in Bangladesh</h5><hr><br>
             ...
             <!--         <div class="col-lg-10">
                        ...
                        <div class="col-lg-3">
                          ...
                          <div class="col-lg-9" style="">
                              <h6 class="text-info"style="font-size:14px;"><strong><?php ?></strong> <strong><?php  ?></strong></h6>
                              <p class="card-text text-left " style="font-size:12px;"><?php  ?> </p>
                          </div>
                        </div>
                      </div> -->
...
<!----------------------------------------all ads echo start-------------------------->
     <?php
             ...
             if(isset($_GET['page'])){
              ...
              $offset =($page -1) * $limit;
                 $qu ="SELECT * FROM ad_post WHERE able='able' ORDER BY post_id DESC LIMIT {$offset}, {$limit}";
     ...
     <!--------------------------------Ads echo end--------------------------------->
                    ...
                    <?php 
                        ...
                        $sql1 = "SELECT * FROM ad_post WHERE able='able'";
                        ...
                        if(mysqli_num_rows($result1) > 0){
                            ...
                            if($page > 1){
                                ...
                                <a href="all-ads.php?page='.($page - 1).'" class="page-link font-weight-bold">Prev</a>
                                </li>';
                            }
                            for($i =1; $i<=$total_page; $i++){
                                ...
                                <a class="page-link font-weight-bold" href="all-ads.php?page='.$i.'">'.$i.'</a>
                                </li>  ';
                             
                            }
                            if($total_page > $page){
                                echo '<li class="page-item ">
                            <a  href="all-ads.php?page='.($page + 1).'" class="page-link font-weight-bold" >Next</a>
                            </li>';
                            }
                            echo '</ul></nav>';
